...
const AdminDashboard = () => {
    ...
    const fetchVouchers = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `${baseUrl}/api/users/adminDashboard?userId=${user?._id}`,
          {
            headers: {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
      <CardDataStats
        title="Total Vouchered Users"
        total={data?.totalVoucherUsers}
        levelUp
      >
        <svg
      ...
      <CardDataStats title="Total Users" total={data?.totalUsers} levelDown>
        <svg
          className="fill-primary dark:fill-white"
          width="22"
          height="18"
